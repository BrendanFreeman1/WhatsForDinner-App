    ...
    public partial class App : Application
    {
        ...
        async protected override void OnStart()
        {
            ...
            List<Dinner> AllDinnersList = new List<Dinner>
            {
                ...
                //Italian
                new Dinner { ID = 0, Text = "Bolognese", Type = "Italian", Ingredients = "Mince, Carrots, Celery, Onion, Garlic, Tin Tomatoes, Tomato Paste, Stock, Cheese", Recipe = "https://www.sbs.com.au/food/recipes/classic-bolognese" },
                ...
                new Dinner { ID = 0, Text = "Cabonara", Type = "Italian", Ingredients = "Bacon, Garlic, Fettuccine, Cheese, Cream, Egg" },
                new Dinner { ID = 0, Text = "Pesto Pasta", Type = "Italian", Ingredients = "Basil Pesto, Bacon, Garlic, Pasta of Choice, Cheese, Cream" },
                new Dinner { ID = 0, Text = "Pasta Bake", Type = "Italian", Ingredients = "Pasta of Choice, Pasta Bake Sauce, Cheese, Ingredients for type of Pasta Bake" },
                ...
                new Dinner { ID = 0, Text = "Gozleme", Type = "Weekend", Ingredients = "Flour, Feta, Spinich, Garlic, Eggs, Cheese", Recipe = "https://www.recipetineats.com/gozleme/" },
                new Dinner { ID = 0, Text = "Quiche", Type = "", Ingredients = "Eggs, Bacon, Oats, Self Raising Flour, Butter, Cheese", Recipe = "https://www.bestrecipes.com.au/recipes/easy-quiche-recipe/bym5vl9w" },
